...
# adjacent to the right angle of an orthogonal triangle. The function should return the length of the hypotenuse, 
...
def hypotenuse(leg1: float, leg2: float):
    sum_of_side_sq = (leg1 ** 2) + (leg2 ** 2)
    return sqrt(sum_of_side_sq)
